    ...
    <div class="absolute inset-0 flex items-center justify-center p-4 pointer-events-none">
        <div class="glass-panel w-full max-w-lg rounded-3xl shadow-2xl transform scale-95 opacity-0 transition-all duration-300 border border-gray-700 pointer-events-auto" id="addStudentModalContent">
            <div class="p-6 border-b border-white/5 flex justify-between items-center bg-white/5 rounded-t-3xl">
                <div>
                    <h3 class="text-xl font-black text-white uppercase italic tracking-tighter">Enroll Students</h3>
                    <p class="text-[8px] text-gray-500 font-bold uppercase tracking-widest italic tracking-tighter mt-1">Bulk Integration Protocol</p>
                </div>
            ...
            <div class="p-6 space-y-6">
                <div class="p-4 bg-primary-500/10 border border-primary-500/20 rounded-2xl">
                    <p class="text-[9px] font-black text-primary-500 uppercase tracking-widest italic mb-2">Class Hub Code</p>
                ...
                <div>
                    <label class="block text-[10px] font-black text-gray-500 uppercase tracking-widest mb-2 italic">Manual Bulk Import</label>
                    <textarea id="bulkNames" rows="5" class="w-full bg-dark-bg border border-dark-border rounded-2xl px-5 py-4 text-white focus:ring-2 focus:ring-primary-500 outline-none transition-all placeholder:italic placeholder:uppercase font-bold text-xs" placeholder="ENTER NAMES OR EMAIL ADDRESSES&#10;SEPARATED BY NEW LINE..."></textarea>
                </div>
            </div>
            <div class="p-6 border-t border-white/5 flex justify-end gap-3 bg-white/5 rounded-b-3xl">
                <button onclick="closeModal('addStudentModal')" class="px-6 py-2.5 rounded-xl text-gray-400 hover:text-white hover:bg-white/5 transition-all text-[10px] font-black uppercase tracking-widest italic">Abort</button>
                <button onclick="processBulkAdd()" class="px-8 py-2.5 rounded-xl bg-primary-600 hover:bg-primary-700 text-white text-[10px] font-black uppercase tracking-widest italic shadow-lg shadow-primary-500/20 transition-all active:scale-95">Enroll Students</button>
            </div>
        </div>
    </div>
</div>
