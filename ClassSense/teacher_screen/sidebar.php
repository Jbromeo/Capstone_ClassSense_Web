...
<aside id="sidebar" class="hidden md:flex flex-col w-64 h-full glass-sidebar z-30 transition-all duration-300 transform border-r border-dark-border">
    ...
    <div class="h-20 flex items-center px-8 border-b border-dark-border">
        <a href="teacher_dashboard.php" class="flex items-center space-x-3 group text-decoration-none">
            <div class="w-8 h-8 rounded-lg bg-gradient-to-br from-[#ea2628] to-[#9d8989] flex items-center justify-center shadow-lg shadow-[#ea2628]/20 mr-3 transition-transform group-hover:scale-110">
    ...
    <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-1 custom-scrollbar">
        ...
        <div class="space-y-1">
            ...
            <div class="ml-9 pl-4 border-l border-dark-border/50 space-y-1 py-2 animate-fade-in">
                <!-- Return to Global Classes (Restored from old sidebar logic) -->
                <a href="classes.php" class="flex items-center px-4 py-2 text-[9px] font-black text-gray-500 hover:text-white uppercase tracking-widest mb-4 bg-white/5 rounded-lg border border-white/5 hover:border-primary-500/30 transition-all italic no-underline">
                    <i data-feather="arrow-left" class="w-3 h-3 mr-2"></i> ALL CLASSES
                </a>

                <button id="nav-students" onclick="switchTab('students')" class="w-full class-control-nav active group flex items-center px-4 py-2 text-[11px] font-bold rounded-lg transition-all text-white bg-white/5 border border-white/5">
                    <i data-feather="users" class="w-3.5 h-3.5 mr-3 text-primary-500"></i>
                    Class Roster
                </button>

                <button id="nav-grading" onclick="switchTab('grading')" class="w-full class-control-nav group flex items-center px-4 py-2 text-[11px] font-bold text-gray-400 hover:text-white rounded-lg transition-all">
                    <i data-feather="edit-3" class="w-3.5 h-3.5 mr-3 text-gray-500 group-hover:text-primary-500 transition-colors"></i>
                    Grading Engine
                </button>

                <button id="nav-attendance" onclick="switchTab('attendance')" class="w-full class-control-nav group flex items-center px-4 py-2 text-[11px] font-bold text-gray-400 hover:text-white rounded-lg transition-all">
